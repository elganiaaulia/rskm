                            ...
                            ?>
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        <button type="button" class="btn btn-sm btn-danger" id="btnHapus" onclick="deleteperiode(<?= $id ?>)" title="Hapus Periode"><i class="fa-solid fa-trash"></i></button>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
...
<script>
    function deleteperiode(id) {
        $('#mdlHapus').modal('show');
        $('#btnkonf').attr("href", "hapus-periode.php?id=" + id);
    }
</script>
