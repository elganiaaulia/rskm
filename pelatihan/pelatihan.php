                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $data['bukti'] ?></td>
                                    <td align="center">
                                        <button type="button" class="btn btn-sm btn-danger" id="btnHapus" onclick="deletepelatihan(<?= $id ?>)" title="Hapus Pelatihan" data-id="<?= $id ?>"><i class="fa-solid fa-trash"></i></button>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
...
<script>
    function deletepelatihan(id) {
        $('#mdlHapus').modal('show');
        $('#btnkonf').attr("href", "hapus-pelatihan.php?id=" + id);
    }
</script>
